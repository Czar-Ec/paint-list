...
export class FilterService {
  ...
  private _fullPaintList: Paint[] | null = null;

  private filteredPaintList: Paint[] | null = null;

  public filteredList$ = signal<Paint[] | null>(null);
    ...
    this.filteredPaintList = this._fullPaintList!
      .filter((paint: Paint) => {
        ...
        return (
          ...
          paint.paintBrand.brandId.toLowerCase().includes(filter) ||
